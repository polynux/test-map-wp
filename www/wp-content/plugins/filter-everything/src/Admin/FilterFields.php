...
class FilterFields
{
    ...
    public function getEmptyFilterObject( $set_id )
    {
        ...
        return $this->prepareFilterInputs( $filter, $this->getFilterNames( $set_id ) );
    }
    ...
    public function getFiltersInputs( $set_id )
    {
        ...
        foreach ( $filters as $field_key => $filter ){
            $preparedFilters[] = $this->prepareFilterInputs( $filter, $this->getFilterNames( $set_id ) );
        }

        return $preparedFilters;
    }

    private function prepareFilterInputs( $filter, $filternames )
    {
        $postTypes  = false;
        $terms      = [];
