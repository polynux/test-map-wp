...
class AdminifyPromo
{
    ...
    public function jltwp_adminify_latest_update_details()
    {
        ...
        $jltwp_adminify_changelog_message = sprintf(
            ...
            esc_url_raw( 'https://wpadminify.com/updates/v3-0-0/' ),
            ...
            // %3$s
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> ACF,Toolset, Pods, Metabox supports for Admin Columns</span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> "Menu Editor" - Drag & Drop Custom Icon uploader added </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Added settings for "Frontend Admin Bar" to disable based on user roles </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Woocommerce admin bar style issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Media library single item button padding isue </span><br>', 'adminify' )
        );
