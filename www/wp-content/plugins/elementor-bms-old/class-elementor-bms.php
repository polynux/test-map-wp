...
/**
 * Main Elementor BMS Class
 *
 * The init class that runs the Elementor Bms plugin.
...
final class Elementor_Bms
{
	...
	public function i18n()
	{
		...
		load_plugin_textdomain('elementor-bms', false, basename(dirname(__FILE__)) . '/languages/');
	}
...
>>>>>>> bec4bcf7... update all
	...
	{
		deactivate_plugins(plugin_basename(ELEMENTOR_BMS));
